 ...
 */
export async function getPublicBusinessMatchingEvents(eventId: string): Promise<BusinessMatchingEvent[]> {
 ...
 */
export async function getBusinessHosts(eventId: string): Promise<BusinessHost[]> {
 ...
 */
export async function getHostAvailability(eventId: string, hostUserId: string, force = false): Promise<AvailabilityResponse> {
    const url = force
...
): Promise<Booking> { // Changed return type to Promise<Booking>
...
export async function downloadBookingsReport(
    ...
    const { blob } = await restClient.postBlob(url, { business_matching_event_ids: bmEventIds });
 ...
 */
export async function joinBusinessHost(eventId: string, bmEventId: string): Promise<void> {
 ...
 */
export async function removeHost(eventId: string, bmEventId: string): Promise<void> {
 ...
 */
export async function getPublicBookingById(bookingId: string, bmEventId: string, eventId: string): Promise<Booking> {
