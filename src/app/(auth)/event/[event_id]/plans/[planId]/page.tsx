...
import { ArrowLeft, Download, Save, Loader2, Users, Sparkles, ChevronLeft, ChevronRight, PanelLeftClose, PanelLeftOpen, PanelRightClose, PanelRightOpen } from "lucide-react";
...
function PlanEditorContent({ initialPlan, eventId }: { initialPlan: any, eventId: string }) {
  const queryClient = useQueryClient();
