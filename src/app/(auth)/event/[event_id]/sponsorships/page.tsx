...
import { useEventSponsorships, useEventSponsorshipTiers } from "@/hooks/use-event-sponsorships";
  ...
  return (
    <div className="space-y-6">
      {isLoading ? (
        ...
        <Tabs defaultValue="sponsorships" onValueChange={setActiveTab} className="w-full">
          ...
          <div className="mt-6">
            <TabsContent value="sponsorships" className="mt-0">
              <EventSponsorshipsView eventId={event_id} sponsorships={sponsorships || []} tiers={tiers || []} />
            </TabsContent>

            <TabsContent value="tiers" className="mt-0">
              <EventSponsorshipTiersView eventId={event_id} tiers={tiers || []} />
            </TabsContent>
          </div>
        </Tabs>
      )}
