				...
				<div className="mb-12 text-center">
					...
					<div className="mx-auto mb-6 max-w-4xl space-y-4 text-sm text-muted-foreground sm:text-base">
						<p className="leading-relaxed">
							...
							access to and use of our event management platform, website, mobile applications, and related 
						...
						<div className="mx-auto flex max-w-5xl gap-3 rounded-lg border border-primary/30 bg-primary/5 p-4 text-left">
							...
							<p className="text-sm leading-relaxed">
								...
								upon posting on our website. Your continued use of the Services following any modifications 
					...
					<div className="space-y-8">
							...
							<div className="space-y-6 text-sm text-muted-foreground sm:text-base">
								<div>
									...
									<p className="leading-relaxed">
										...
										requirements. If you are using the Services on behalf of an organization, you represent and warrant 
							...
							<div className="space-y-6 text-sm text-muted-foreground sm:text-base">
								<div>
									...
									<p className="leading-relaxed">
										...
										copyright, trademark, patent, trade secret, and other intellectual property laws. You are granted 
										a limited, non-exclusive, non-transferable, revocable license to access and use the Services for 
								...
								<div>
									...
									<p className="leading-relaxed">
										...
										transferable, sublicensable license to use, reproduce, modify, adapt, publish, translate, create 
										derivative works from, distribute, and display such User Content solely for the purpose of 
							...
							<div className="space-y-6 text-sm text-muted-foreground sm:text-base">
								<div>
									...
									<p className="leading-relaxed">
										...
										stated in our refund policy or required by law.
									</p>
								</div>
								...
								<div>
									...
									<p className="leading-relaxed">
										...
										the renewal date. We reserve the right to modify pricing with 30 days' notice.
									</p>
								</div>
							...
							<div className="space-y-6 text-sm text-muted-foreground sm:text-base">
								<div>
									...
									<p className="leading-relaxed">
										...
										to paid features until the end of the paid period.
									</p>
								</div>
								...
								<div>
									...
									<p className="leading-relaxed">
										...
										your User Content after termination, except as required by law.
									</p>
								</div>
							</div>
						</PolicySection>
						...
						<PolicySection id="disclaimers" sectionNumber={7} title="Disclaimers and Warranties" icon={AlertTriangle}>
							<div className="space-y-4 text-sm text-muted-foreground sm:text-base">
								...
								<p className="leading-relaxed">
									Your use of the Services is at your sole risk. You are solely responsible for any damage to your 
									computer system or loss of data resulting from the use of the Services.
								</p>
							</div>
						</PolicySection>
						...
						<PolicySection id="liability" sectionNumber={8} title="Limitation of Liability" icon={Shield}>
							<div className="space-y-4 text-sm text-muted-foreground sm:text-base">
								...
								<p className="leading-relaxed">
									...
									LEGAL THEORY, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF THE SERVICES, EVEN IF ADVISED OF 
									THE POSSIBILITY OF SUCH DAMAGES.
								</p>
								<p className="leading-relaxed">
									OUR TOTAL LIABILITY TO YOU FOR ALL CLAIMS ARISING OUT OF OR RELATING TO THESE TERMS OR THE SERVICES 
									SHALL NOT EXCEED THE AMOUNT YOU PAID TO US IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM, OR ONE 
						...
						<PolicySection id="indemnification" sectionNumber={9} title="Indemnification" icon={Shield}>
							<div className="space-y-4 text-sm text-muted-foreground sm:text-base">
								<p className="leading-relaxed">
									...
									representatives from and against any claims, liabilities, damages, judgments, awards, losses, costs, 
							...
							<div className="space-y-6 text-sm text-muted-foreground sm:text-base">
								...
								<div>
									...
									<p className="leading-relaxed">
										...
										If the dispute cannot be resolved through negotiation within 30 days, either party may initiate 
						...
						<PolicySection id="third-party" sectionNumber={12} title="Third-Party Services and Links" icon={Globe}>
							<div className="space-y-4 text-sm text-muted-foreground sm:text-base">
								...
								<p className="leading-relaxed">
									You acknowledge and agree that EventzFlow shall not be responsible or liable for any damage or 
									loss caused by your use of any third-party services. We strongly advise you to read the terms 
									and conditions and privacy policies of any third-party services you access.
								</p>
							</div>
						</PolicySection>
						...
						<PolicySection id="entire-agreement" sectionNumber={15} title="Entire Agreement" icon={FileText}>
							<p className="text-sm leading-relaxed text-muted-foreground sm:text-base">
								...
								oral or written, between you and EventzFlow.
							</p>
						</PolicySection>
