...
export default function CheckinLayout({
	...
	return (
		<div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-emerald-950/20">
			...
			<div className="-top-24 -right-24 absolute h-96 w-96 animate-pulse rounded-full bg-gradient-to-br from-emerald-400/20 to-teal-400/20 blur-3xl" 
				style={{ animationDuration: '8s' }} 
			/>
			<div className="-left-32 absolute top-1/3 h-80 w-80 animate-pulse rounded-full bg-gradient-to-tr from-blue-400/10 to-emerald-400/10 blur-3xl" 
				style={{ animationDuration: '10s', animationDelay: '2s' }} 
			/>
			<div className="-bottom-32 absolute right-1/4 h-72 w-72 animate-pulse rounded-full bg-gradient-to-tl from-emerald-300/15 to-cyan-300/15 blur-3xl" 
			...
			<div className="absolute top-4 left-4 z-20">
				<Button variant="outline" asChild className="bg-white/80 backdrop-blur-sm dark:bg-slate-900/80">
