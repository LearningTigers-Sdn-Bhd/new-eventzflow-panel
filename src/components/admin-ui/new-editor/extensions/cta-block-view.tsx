          ...
          <div className="flex flex-col items-center gap-4">
            {buttonUrl && !isEditable ? (
              <a
                ...
                className="inline-flex h-14 min-w-45 cursor-pointer items-center justify-center rounded-none border-2 border-foreground bg-foreground px-4 font-bold text-background uppercase tracking-widest shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 hover:translate-x-0.5 hover:translate-y-0.5 hover:bg-background hover:text-foreground hover:shadow-none dark:shadow-foreground/30"
              >
                {buttonText || "Get Started"}
                <ExternalLink className="ml-2 h-4 w-4" />
              </a>
            ) : (
              <Button className="h-14 min-w-45 cursor-pointer rounded-none border-2 border-foreground bg-foreground font-bold text-background uppercase tracking-widest shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 hover:translate-x-0.5 hover:translate-y-0.5 hover:bg-background hover:text-foreground hover:shadow-none dark:shadow-foreground/30">
                {buttonText || "Get Started"}
                <ExternalLink className="ml-2 h-4 w-4" />
              </Button>
            )}
