...
import { ChevronDown, Hash, ListTree } from "lucide-react";
...
export function RichDisplayOutline({
	...
	const containerClass = cn(
		"flex h-full flex-col overflow-hidden bg-background transition-all duration-200",
	...
	return (
		<div className={containerClass}>
			<button
				...
				className="flex w-full shrink-0 cursor-pointer items-center justify-between gap-2 px-4 py-4 transition-colors hover:bg-muted"
			>
