...
const features = [
  {
    ...
    description:
      "Customizable registration forms that capture exactly the data you need from attendees.",
  },
  {
    title: "WHATSAPP BOT",
    description:
      "Let attendees register directly via WhatsApp with automated responses and confirmations.",
  },
  {
    title: "TICKET TYPES",
    description:
  ...
  },
  {
    ...
    description:
      "Every registrant receives a unique QR code for fast check-in at your event.",
  },
  {
    title: "BULK IMPORT",
    description:
      "Import hundreds of attendees at once via CSV or Excel spreadsheets.",
  },
  {
    title: "CUSTOM FIELDS",
    description:
        ...
        <div className="mb-16 md:mb-20">
          ...
          >
            ...
            <h2 className="font-black text-3xl uppercase tracking-tighter text-black sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl">
              Everything you need for seamless registration
            </h2>
          </motion.div>
        </div>
