...
// Event column for vendor vouchers view
const eventColumn: ColumnDef<VendorVoucher> = {
	id: "event",
...
// Actions column
const actionsColumn: ColumnDef<VendorVoucher> = {
	id: "actions",
	size: 80,
	enableHiding: false,
...
// Export columns with actions
export const vendorVoucherColumns: ColumnDef<VendorVoucher>[] = [
	...baseColumns,
	actionsColumn,
];
