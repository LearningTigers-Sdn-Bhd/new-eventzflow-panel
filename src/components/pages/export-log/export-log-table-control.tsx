...
import { type DateRange, DateRangeFilter } from "./date-range-filter";
...
export function ExportLogTableControl<TData>({
	...
	const dateRange: DateRange = (table
		.getColumn("createdAt")
		...
		return (
			<div className="mb-4 flex flex-col border border-dashed bg-transparent px-0 py-0 md:px-2 md:py-4 lg:bg-accent lg:px-4 lg:py-4">
				<div className="hidden items-center gap-2 lg:flex">
					<QuerySearchField table={table} placeholder="Search export logs..." />
					<Select
