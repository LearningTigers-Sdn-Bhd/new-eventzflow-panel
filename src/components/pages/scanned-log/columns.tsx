...
import { ArrowDown, Eye, Mail, Phone, User } from "lucide-react";
	...
	return (
		<div className="space-y-5">
			...
			<div className="flex items-center gap-4 rounded-lg border border-gray-100 bg-gray-50 p-4">
				<div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-blue-500">
			...
			<div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
				{/* Phone */}
				<div className="flex items-start gap-3 rounded-lg border border-gray-200 bg-white p-3.5 transition-colors hover:bg-gray-50">
					...
					<div className="min-w-0 flex-1">
						...
						<p className="mt-1 truncate font-medium text-gray-900 text-sm">
							{phone}
						</p>
					</div>
				</div>
				...
				<div className="flex items-start gap-3 rounded-lg border border-gray-200 bg-white p-3.5 transition-colors hover:bg-gray-50">
					...
					<div className="min-w-0 flex-1">
						...
						<p className="mt-1 break-all font-medium text-gray-900 text-sm">
							{email}
						</p>
					</div>
				</div>
