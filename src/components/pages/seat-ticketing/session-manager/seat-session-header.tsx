			...
			<div className="relative flex items-center justify-between border-b px-6 py-3 bg-background shrink-0 h-16">
				...
				<div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
					...
					<p className="text-sm text-muted-foreground">
						{selectedSection.event_ticket_seats?.length || 0} Seat Placements
					</p>
				</div>
				    ...
				    return (
				        ...
				        <div className="relative flex items-center justify-between border-b px-6 py-3 bg-background shrink-0 h-16">
				            ...
				            <div className="flex items-center gap-4 z-10">
				                ...
				                <Button variant="ghost" size="sm" className="gap-2 pl-2 rounded-none" asChild>
				            ...
				            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
				                ...
				                <p className="text-sm text-muted-foreground">Venue Blueprint</p>
