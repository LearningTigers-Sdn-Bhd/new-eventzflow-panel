...
export default function SeatSummary({
	...
	return (
		<div className="flex h-full flex-col">
			<div className="border-slate-200 border-b px-6 pb-6 md:px-12">
				<h2 className="font-black text-2xl text-slate-900 uppercase tracking-tight">
					Review Selection
				</h2>
				<p className="font-semibold text-slate-500 text-sm">
					{seats.length} {seats.length === 1 ? "seat" : "seats"} reserved for
					you
				</p>
			</div>
				...
				<div className="divide-y divide-slate-100">
					{seats.map((seat) => {
						...
						return (
							<div
								key={seat.id}
								className="group flex items-center justify-between px-6 py-8 transition-all md:px-12"
							>
								<div className="flex flex-col gap-1">
									<p className="font-black text-slate-900 text-xl leading-tight md:text-2xl">
										{seat.name}
									</p>
								...
								<div className="text-right">
									<p className="font-bold font-mono text-lg text-slate-900 md:text-xl">
										RM
										{(
			...
			<div className="mt-auto flex items-center justify-between border-slate-900 border-t-2 px-6 pt-8 pb-4 md:px-12">
