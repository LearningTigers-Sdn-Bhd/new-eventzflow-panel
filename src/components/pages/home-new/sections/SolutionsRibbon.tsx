			...
			<div className="mx-auto max-w-7xl text-center">
				...
				>
					<div className="mb-3 sm:mb-4">
						<span className="inline-block rounded-full bg-primary-foreground/10 px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.2em] text-primary-foreground sm:px-4 sm:text-xs">
