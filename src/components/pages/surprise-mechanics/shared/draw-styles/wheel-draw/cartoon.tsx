...
const SpinWheel: React.FC<DrawProps> = ({
	...
	return (
		<div className="relative mx-auto flex w-full max-w-[500px] flex-col items-center justify-center">
			...
			<div className="relative aspect-square w-full max-w-[500px]">
				...
				<div {...pointerPosition}>
					<svg
						...
						style={{
							transform: `rotate(${pointerRotation}deg)`, // Counter-rotate to keep arrow pointing down
				...
				{isVirtualMode && flashingName && (
					<div className="pointer-events-none absolute inset-0 flex items-center justify-center">
						<div className="max-w-[70%] rounded-xl border-4 border-black bg-linear-to-br from-yellow-400 to-orange-500 px-4 py-3 shadow-2xl">
			...
			{isVirtualMode && (
				<div className="mt-4 flex items-center gap-2 rounded-full border-4 border-black bg-linear-to-r from-yellow-300 to-orange-300 px-4 py-2 shadow-lg">
