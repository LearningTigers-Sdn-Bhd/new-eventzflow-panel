...
import { Handshake, User, Globe, Mail, Phone, FileText } from "lucide-react";
...
import { useCreateSponsor } from "@/hooks/use-sponsorships";

interface CreateSponsorFormProps {
  onClose: () => void;
}

export default function CreateSponsorForm({ onClose }: CreateSponsorFormProps) {
  const nameId = useId();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createSponsorMutation.mutateAsync({
        ...
        default_contact_position: formData.default_contact_position || undefined,
          ...
          <FieldGroup>
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              ...
              <div className="space-y-6">
                ...
                <Field orientation="vertical">
                  <FieldLabel htmlFor={contactNameId}>Contact Person</FieldLabel>
                  <Input
                    id={contactNameId}
                    placeholder="John Doe"
                    value={formData.default_contact_name}
                    onChange={(e) => handleChange("default_contact_name", e.target.value)}
                    disabled={createSponsorMutation.isPending}
                  />
                </Field>
                ...
                <Field orientation="vertical">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleChange("default_contact_position", e.target.value)}
                    disabled={createSponsorMutation.isPending}
                  />
                </Field>
                ...
                <Field orientation="vertical">
                  <FieldLabel htmlFor={contactWhatsappId}>WhatsApp / Phone</FieldLabel>
                  <div className="relative">
