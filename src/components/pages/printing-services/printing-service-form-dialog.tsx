...
import { createPrintingService } from "@/lib/api/printing-service";

export function PrintingServiceFormContent() {
	...
	const createMutation = useMutation({
		...
		onSuccess: () => {
			...
			toast.success("Printing service created successfully");
			closeDialog();
		},
		onError: (error: Error) => {
			toast.error("Failed to create printing service", {
