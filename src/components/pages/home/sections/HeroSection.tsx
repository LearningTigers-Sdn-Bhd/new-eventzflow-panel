...
import { ArrowRight, Play, Sparkles, Star, Ticket, TrendingUp, Users, Zap } from 'lucide-react';
    ...
    const particles = Array.from({ length: particleCount }, (_, i) => {
      ...
      return (
        <motion.div
          ...
          transition={{
            durationNumber.POSITIVE_INFINITYon,
            ...
            <div className="flex flex-col items-center gap-6 sm:gap-8">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 lg:gap-6">
                ...
                >
                  ...
                  <span className="font-medium text-xs sm:text-sm">Real-time Analytics</span>
                </motion.div>
                ...
                >
                  ...
                  <span className="font-medium text-xs sm:text-sm">WhatsApp Flow</span>
                </motion.div>
                ...
                >
                  ...
                  <span className="font-medium text-xs sm:text-sm">Growth Insights</span>
                </motion.div>
              </div>
