...
const faqs = [
	...
	{
		question: "CAN EVENTZFLOW CONNECT WITH OUR EXISTING SYSTEMS?",
		answer:
...
const FAQSection: React.FC = () => {
	...
	return (
		<section
			id="faq"
			className="border border-black bg-white-background px-6 py-16 md:px-12 md:py-30"
		>
				...
				<div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-8">
					...
					<div className="lg:col-span-4">
						<div className="lg:sticky lg:top-40">
							<h2 className="font-black text-4xl text-black tracking-tighter sm:text-5xl md:text-7xl">
								COMMON
								<br />
								QUESTIONS.
							</h2>
					...
					<div className="lg:col-span-8">
						{faqs.map((faq, i) => (
							<motion.div
								...
								className="border-2 border-black/30 transition-all duration-200 hover:border-black"
							>
								<button
									type="button"
									onClick={() => toggleFAQ(i)}
									...
									className="group flex w-full items-start justify-between gap-8 border-black/30 border-b-2 bg-white/60 px-6 py-8 text-left backdrop-blur-sm transition-all duration-200 hover:border-black hover:bg-white/80"
								>
									<div className="flex items-start gap-6">
										...
										<h3
											id={`faq-question-${i}`}
											className="font-bold text-black text-lg leading-tight tracking-tight md:text-xl"
										>
											{faq.question}
										</h3>
									</div>
									...
									{openIndex === i && (
										...
										>
											<div className="bg-white px-6 py-6">
												<p className="text-left text-base text-black/70 leading-relaxed md:text-lg">
													{faq.answer}
												</p>
											</div>
										</motion.div>
