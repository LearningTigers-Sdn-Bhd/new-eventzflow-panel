			...
			<div className="mx-auto max-w-7xl text-center">
				...
				>
					<div className="mb-3 sm:mb-4">
						<span className="inline-flex items-center gap-2 rounded-full bg-primary-foreground/10 px-3 py-1.5 font-semibold text-[10px] text-primary-foreground uppercase tracking-[0.2em] sm:px-4 sm:text-xs">
							<Box className="h-3 w-3 sm:h-3.5 sm:w-3.5" />
							Complete Solution Suite
						</span>
					</div>
					<h2 className="px-2 font-semibold text-primary-foreground text-xl sm:text-2xl lg:text-3xl xl:text-4xl">
