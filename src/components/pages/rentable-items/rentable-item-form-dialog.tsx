...
import { createRentableItem } from "@/lib/api/rentable-item";

export function RentableItemFormContent() {
	...
	const createMutation = useMutation({
		mutationFn: createRentableItem,
		onSuccess: () => {
			queryClient.invalidateQueries({ queryKey: ["rentable-items"] });
			toast.success("Rentable item created successfully");
			closeDialog();
		},
		onError: (error: Error) => {
			toast.error("Failed to create rentable item", {
