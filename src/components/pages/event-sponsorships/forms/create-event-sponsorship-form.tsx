...
export default function CreateEventSponsorshipForm({
	eventId,
	tiers,
	onClose,
}: CreateEventSponsorshipFormProps) {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			const message =
				error instanceof Error ? error.message : "Failed to add sponsorship";
			toast.error(message);
		}
	};
		...
		if (value !== "none") {
			...
			if (tier) {
				setFormData((prev) => ({
					...prev,
					total_sponsor_amount:
						tier.suggested_value || prev.total_sponsor_amount,
