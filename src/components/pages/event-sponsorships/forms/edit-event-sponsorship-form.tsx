...
export default function EditEventSponsorshipForm({ eventId, sponsorship, tiers, onClose }: EditEventSponsorshipFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    event_sponsorship_tier_id: sponsorship.event_sponsorship_tier_id ? sponsorship.event_sponsorship_tier_id.toString() : "none",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : "Failed to update sponsorship";
      toast.error(message);
    }
  };
          ...
          <FieldGroup>
            ...
            <div className="flex justify-end gap-3">
              ...
              <Button type="submit" disabled={updateMutation.isPending}>
                {updateMutation.isPending ? "Updating..." : "Update Sponsorship"}
              </Button>
            </div>
          </FieldGroup>
        </FieldSet>
