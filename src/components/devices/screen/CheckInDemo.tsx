...
import { Camera, CheckCircle, User, XCircle } from "lucide-react";
import type React from "react";
import { useEffect, useState } from "react";
import Phone from "../Phone";

const CheckInDemo: React.FC = () => {
	const [scanState, setScanState] = useState<"scanning" | "valid" | "invalid">(
		"scanning",
	);
					...
					<AnimatePresence mode="wait">
								...
								>
									<div className="mb-2 flex items-center gap-2 border-slate-700 border-b pb-2">
										...
										<div className="flex-1">
											...
											<p className="font-medium text-[10px] text-green-400">
												✓ VALID TICKET
											</p>
										</div>
									</div>
						...
						{scanState === "invalid" && (
							...
							>
								...
								<h4 className="mb-2 font-bold text-lg text-red-400">
									Invalid Ticket
								</h4>
