          ...
          <div className="flex h-full flex-col bg-[#0b141a]">
            ...
            <div className="flex items-center border-[#313d45] border-b bg-[#202c33] px-4 py-3">
              ...
              <div className="flex-1">
                <h6 className="font-medium text-sm text-white">Event Tickets</h6>
            ...
            {/* Chat Messages */}
            <div ref={chatRef} className="scrollbar-hide flex-1 space-y-2 overflow-y-auto px-4 py-2">
              <AnimatePresence>
                {step >= 0 && (
                  <motion.div 
                    key="msg1"
                  ...
                  >
                    <div className="relative max-w-[85%] bg-[#202c33] px-3 py-2 shadow-lg" style={{borderRadius: '7.5px 7.5px 7.5px 0px'}}>
                      <p className="text-sm text-white">Hi! I need 2 tickets for the tech conference 💻</p>
                ...
                {step >= 1 && (
                  <motion.div 
                    ...
                    transition={{ duration: 0.4 }}
                  >
                    <div className="relative max-w-[85%] bg-[#005c4b] px-3 py-2 shadow-lg" style={{borderRadius: '7.5px 7.5px 0px 7.5px'}}>
                      <p className="text-sm text-white">Perfect! Conference tickets available:</p>
                      <div className="mt-2 rounded-md bg-[#004a3d] p-2">
                        <p className="font-semibold text-sm text-white">🎫 Conference Pass - $199 each</p>
                        <p className="text-white/80 text-xs">✨ Full access + networking</p>
                      </div>
                      <div className="mt-1 flex items-center justify-end">
                        <span className="mr-1 text-[#8696a0] text-xs">2:31 PM</span>
                ...
                {step >= 2 && (
                  <motion.div 
                    ...
                    transition={{ duration: 0.4 }}
                  >
                    <div className="relative max-w-[80%] bg-[#202c33] px-3 py-2 shadow-lg" style={{borderRadius: '7.5px 7.5px 7.5px 0px'}}>
                      <p className="text-sm text-white">Great! I'll take 2 conference passes 🎉</p>
                      <div className="mt-1 flex items-center justify-end">
                ...
                {step >= 3 && (
                  <motion.div 
                    ...
                    transition={{ duration: 0.4 }}
                  >
                    <div className="relative max-w-[90%] bg-[#005c4b] px-3 py-2 shadow-lg" style={{borderRadius: '7.5px 7.5px 0px 7.5px'}}>
                      <div className="space-y-2">
                        <p className="font-semibold text-sm text-white">🎊 Order Confirmed!</p>
                      ...
                      <div className="mt-1 flex items-center justify-end">
                        <span className="mr-1 text-[#8696a0] text-xs">2:33 PM</span>
                        <CheckCheck className="h-4 w-4 text-[#53bdeb]" />
                      </div>
                    </div>
                  </motion.div>
        ...
        return (
          <div className="h-full space-y-4 bg-gradient-to-b from-slate-900 to-black p-4">
            <div className="mb-4 text-center">
              <h6 className="mb-1 font-semibold text-white">💰 Revenue Calculator</h6>
            ...
            <div className="space-y-4">
              <AnimatePresence>
                {step >= 0 && (
                  ...
                  >
                    <p className="mb-2 text-slate-300 text-sm">Monthly Ticket Sales</p>
                ...
                {step >= 1 && (
                  ...
                  >
                    <div className="mb-2 flex items-center justify-between">
                      ...
                      <span className="rounded bg-red-500/30 px-2 py-1 text-red-200 text-xs">8% fee</span>
                    </div>
                    <div className="font-bold text-lg text-red-400">
                      $10,000 - $800 = $9,200
                    </div>
                    <p className="mt-1 text-red-300 text-xs">Commission taken from every sale</p>
                  </motion.div>
                )}
                ...
                {step >= 2 && (
                  ...
                  >
                    <div className="mb-2 flex items-center justify-between">
                      ...
                      <span className="rounded bg-green-500/30 px-2 py-1 text-green-200 text-xs">0% fee</span>
                    </div>
                    <div className="font-bold text-green-400 text-lg">
                      $10,000 - $0 = $10,000
                    </div>
                    <p className="mt-1 text-green-300 text-xs">Keep 100% of your revenue!</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
        ...
        return (
          <div className="h-full space-y-3 bg-gradient-to-b from-slate-900 to-black p-3 sm:space-y-4 sm:p-4">
            <div className="mb-3 text-center sm:mb-4">
              <h6 className="mb-1 font-semibold text-sm text-white sm:text-base">📱 QR Check-In Scanner</h6>
              ...
              <AnimatePresence>
                {step >= 0 && (
                  ...
                  >
                    ...
                    <p className="font-medium text-white text-xs sm:text-sm">QR Scanner Ready</p>
                    <p className="text-slate-300 text-xs">Point camera at attendee QR code</p>
                  </motion.div>
                )}
                ...
                {step >= 1 && (
                  ...
                  >
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-white text-xs sm:text-sm">Scanning QR Code...</p>
                ...
                {step >= 2 && (
                  ...
                  >
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-white text-xs sm:text-sm">Sarah Martinez</p>
                        <p className="text-green-300 text-xs">Conference Pass - Valid ✓</p>
                        <p className="text-slate-300 text-xs">Check-in: 9:15 AM</p>
                      </div>
                    </div>
                  </motion.div>
                )}
                ...
                {step >= 3 && (
                  ...
                  >
                    <div className="grid grid-cols-2 gap-2 text-center sm:gap-3">
                      <div>
                        <p className="font-bold text-base text-white sm:text-lg">247</p>
                        <p className="text-slate-400 text-xs">Checked In</p>
                      </div>
                      <div>
                        <p className="font-bold text-base text-white sm:text-lg">53</p>
          ...
          <div className="flex h-full flex-col bg-[#0b141a]">
            ...
            <div className="flex items-center border-[#313d45] border-b bg-[#202c33] px-3 py-2 sm:px-4 sm:py-3">
              <div className="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-br from-green-400 to-blue-500 sm:mr-3 sm:h-8 sm:w-8">
                <span className="font-bold text-white text-xs sm:text-sm">🎫</span>
              </div>
              <div className="flex-1">
                <h6 className="font-medium text-white text-xs sm:text-sm">Eventzflow App</h6>
                <p className="text-[#8696a0] text-xs">Event Registration</p>
              </div>
            </div>

            {/* Mini App Content */}
            <div ref={miniAppRef} className="scrollbar-hide flex-1 space-y-2 overflow-y-auto px-3 py-2 sm:space-y-3 sm:px-4 sm:py-3">
              <AnimatePresence>
                {step >= 0 && (
                  <motion.div 
                    key="event-card"
                  ...
                  >
                    <div className="mb-2 flex items-center space-x-2 sm:mb-3 sm:space-x-3">
                      ...
                      <div>
                        <h6 className="font-semibold text-white text-xs sm:text-sm">Tech Summit 2024</h6>
                ...
                {step >= 1 && (
                  <motion.div 
                    ...
                    transition={{ duration: 0.4 }}
                  >
                    <h6 className="mb-2 font-medium text-white text-xs sm:mb-3 sm:text-sm">Select Tickets</h6>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between rounded-md bg-[#005c4b] p-2 sm:rounded-lg">
                        ...
                        <div className="text-right">
                          <p className="font-semibold text-white text-xs sm:text-sm">$199</p>
                          <div className="flex items-center space-x-1 sm:space-x-2">
                            <button className="h-5 w-5 rounded bg-[#004a3d] text-white text-xs sm:h-6 sm:w-6">-</button>
                            <span className="text-white text-xs sm:text-sm">2</span>
                            <button className="h-5 w-5 rounded bg-[#00a884] text-white text-xs sm:h-6 sm:w-6">+</button>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                {step >= 2 && (
                  <motion.div 
                    ...
                    transition={{ duration: 0.4 }}
                  >
                    <h6 className="mb-2 font-medium text-white text-xs sm:mb-3 sm:text-sm">Your Details</h6>
                    <div className="space-y-2">
                      <input 
                        type="text" 
                ...
                {step >= 3 && (
                  ...
                  >
                    <div className="text-center">
                      ...
                      <h6 className="mb-1 font-semibold text-white text-xs sm:text-sm">Payment Successful!</h6>
                      <p className="mb-2 text-[#8696a0] text-xs">2x Conference Pass - $398</p>
